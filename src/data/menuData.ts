...
const vegDishes: Dish[] = [
    ...
    { id: 4, image: 'https://images.unsplash.com/photo-1626082927389-d31c0d02468e?w=500', text: 'Hummus & Pita', description: 'Creamy chickpea dip with olive oil and paprika.', price: '£8.99', rating: 4.6, category: 'veg', displayCategory: 'Starters' },
    ...
    { id: 7, image: 'https://images.unsplash.com/photo-1585937421612-70a008356f36?w=500', text: 'Stuffed Grape Leaves', description: 'Dolmas filled with herbed rice.', price: '£9.49', rating: 4.5, category: 'veg', displayCategory: 'Starters' },
    ...
    { id: 13, image: 'https://images.unsplash.com/photo-1585937421612-70a008356f36?w=500', text: 'Dal Makhani', description: 'Creamy black lentils slow-cooked overnight.', price: '£11.99', rating: 4.6, category: 'veg', displayCategory: 'Mains' },
    ...
    { id: 17, image: 'https://images.unsplash.com/photo-1626082927389-d31c0d02468e?w=500', text: 'Mushroom Masala', description: 'Rich mushroom curry.', price: '£11.99', rating: 4.5, category: 'veg', displayCategory: 'Mains' },
    ...
    { id: 19, image: 'https://images.unsplash.com/photo-1585937421612-70a008356f36?w=500', text: 'Mixed Veg Curry', description: 'Assorted vegetables in rich gravy.', price: '£10.99', rating: 4.4, category: 'veg', displayCategory: 'Mains' },
    ...
    { id: 22, image: 'https://images.unsplash.com/photo-1626082927389-d31c0d02468e?w=500', text: 'Tarka Dal', description: 'Yellow lentils with tempered spices.', price: '£9.99', rating: 4.3, category: 'veg', displayCategory: 'Mains' },
    ...
    { id: 24, image: 'https://images.unsplash.com/photo-1585937421612-70a008356f36?w=500', text: 'Paneer Jalfrezi', description: 'Stir-fried paneer with vegetables.', price: '£12.49', rating: 4.5, category: 'veg', displayCategory: 'Mains' },
    ...
    { id: 28, image: 'https://images.unsplash.com/photo-1585937421612-70a008356f36?w=500', text: 'Vegetarian Thali', description: 'Complete Indian meal platter.', price: '£22.99', rating: 4.9, category: 'veg', displayCategory: 'Platters' },
    ...
    { id: 34, image: 'https://images.unsplash.com/photo-1585937421612-70a008356f36?w=500', text: 'Kheer', description: 'Creamy rice pudding.', price: '£5.49', rating: 4.5, category: 'veg', displayCategory: 'Desserts' },
    ...
    { id: 37, image: 'https://images.unsplash.com/photo-1626082927389-d31c0d02468e?w=500', text: 'Kulfi', description: 'Traditional Indian ice cream.', price: '£4.49', rating: 4.6, category: 'veg', displayCategory: 'Desserts' },
    ...
    { id: 40, image: 'https://images.unsplash.com/photo-1585937421612-70a008356f36?w=500', text: 'Sweet Lassi', description: 'Traditional yogurt drink.', price: '£3.99', rating: 4.5, category: 'veg', displayCategory: 'Drinks' },
    ...
    { id: 43, image: 'https://images.unsplash.com/photo-1626082927389-d31c0d02468e?w=500', text: 'Rose Sherbet', description: 'Traditional rose-flavored drink.', price: '£3.49', rating: 4.4, category: 'veg', displayCategory: 'Drinks' },
    ...
    { id: 46, image: 'https://images.unsplash.com/photo-1585937421612-70a008356f36?w=500', text: 'Butter Naan', description: 'Classic buttered naan bread.', price: '£2.99', rating: 4.5, category: 'veg', displayCategory: 'Breads' },
    ...
    { id: 49, image: 'https://images.unsplash.com/photo-1626082927389-d31c0d02468e?w=500', text: 'Roti', description: 'Traditional whole wheat bread.', price: '£2.49', rating: 4.3, category: 'veg', displayCategory: 'Breads' },
...
const nonVegDishes: Dish[] = [
    ...
    { id: 56, image: 'https://images.unsplash.com/photo-1585937421612-70a008356f36?w=500', text: 'Chicken Malai Tikka', description: 'Creamy marinated chicken pieces.', price: '£11.49', rating: 4.7, category: 'non-veg', displayCategory: 'Starters' },
    ...
    { id: 59, image: 'https://images.unsplash.com/photo-1626082927389-d31c0d02468e?w=500', text: 'Chicken Lollipop', description: 'Spicy chicken drumettes.', price: '£10.49', rating: 4.5, category: 'non-veg', displayCategory: 'Starters' },
    ...
    { id: 62, image: 'https://images.unsplash.com/photo-1585937421612-70a008356f36?w=500', text: 'Butter Chicken', description: 'Classic rich tomato and cream curry.', price: '£14.99', rating: 4.8, category: 'non-veg', displayCategory: 'Mains' },
    ...
    { id: 65, image: 'https://images.unsplash.com/photo-1626082927389-d31c0d02468e?w=500', text: 'Lamb Biryani', description: 'Aromatic rice with tender lamb.', price: '£16.99', rating: 4.9, category: 'non-veg', displayCategory: 'Mains' },
    ...
    { id: 67, image: 'https://images.unsplash.com/photo-1585937421612-70a008356f36?w=500', text: 'Prawn Masala', description: 'Tiger prawns in rich sauce.', price: '£17.99', rating: 4.8, category: 'non-veg', displayCategory: 'Mains' },
    ...
    { id: 70, image: 'https://images.unsplash.com/photo-1626082927389-d31c0d02468e?w=500', text: 'Chicken Jalfrezi', description: 'Stir-fried chicken with peppers.', price: '£13.49', rating: 4.5, category: 'non-veg', displayCategory: 'Mains' },
    ...
    { id: 72, image: 'https://images.unsplash.com/photo-1585937421612-70a008356f36?w=500', text: 'Chicken Madras', description: 'Hot and tangy chicken curry.', price: '£12.99', rating: 4.4, category: 'non-veg', displayCategory: 'Mains' },
    ...
    { id: 75, image: 'https://images.unsplash.com/photo-1626082927389-d31c0d02468e?w=500', text: 'Lamb Dhansak', description: 'Sweet-sour lamb with lentils.', price: '£15.99', rating: 4.6, category: 'non-veg', displayCategory: 'Mains' },
    // Wraps - Non-Veg
    ...
    { id: 77, image: 'https://images.unsplash.com/photo-1585937421612-70a008356f36?w=500', text: 'Lamb Shawarma Wrap', description: 'Tender lamb in flatbread.', price: '£10.99', rating: 4.8, category: 'non-veg', displayCategory: 'Wraps' },
    ...
    { id: 80, image: 'https://images.unsplash.com/photo-1626082927389-d31c0d02468e?w=500', text: 'Fish Wrap', description: 'Crispy fish in tortilla.', price: '£10.49', rating: 4.4, category: 'non-veg', displayCategory: 'Wraps' },
    // Platters - Non-Veg
    ...
    { id: 84, image: 'https://images.unsplash.com/photo-1585937421612-70a008356f36?w=500', text: 'Chicken Feast', description: 'Assorted chicken dishes.', price: '£26.99', rating: 4.7, category: 'non-veg', displayCategory: 'Platters' },
    ...
    { id: 87, image: 'https://images.unsplash.com/photo-1626082927389-d31c0d02468e?w=500', text: 'Lamb Pulao', description: 'Spiced rice with lamb chunks.', price: '£12.99', rating: 4.6, category: 'non-veg', displayCategory: 'Rice' },
    ...
    { id: 89, image: 'https://images.unsplash.com/photo-1585937421612-70a008356f36?w=500', text: 'Keema Rice', description: 'Minced beef with basmati rice.', price: '£11.99', rating: 4.5, category: 'non-veg', displayCategory: 'Rice' },
    ...
    { id: 92, image: 'https://images.unsplash.com/photo-1626082927389-d31c0d02468e?w=500', text: 'Whole Grilled Fish', description: 'Fresh fish grilled to perfection.', price: '£24.99', rating: 4.8, category: 'non-veg', displayCategory: 'Specialties' },
    ...
    { id: 94, image: 'https://images.unsplash.com/photo-1585937421612-70a008356f36?w=500', text: 'Lamb Shoulder', description: 'Slow-roasted lamb shoulder.', price: '£28.99', rating: 4.9, category: 'non-veg', displayCategory: 'Specialties' },
    ...
    { id: 97, image: 'https://images.unsplash.com/photo-1626082927389-d31c0d02468e?w=500', text: 'Lamb Rack', description: 'Premium rack of lamb.', price: '£34.99', rating: 4.9, category: 'non-veg', displayCategory: 'Specialties' },
    ...
    { id: 99, image: 'https://images.unsplash.com/photo-1585937421612-70a008356f36?w=500', text: 'Grilled Salmon', description: 'Fresh Atlantic salmon.', price: '£19.99', rating: 4.7, category: 'non-veg', displayCategory: 'Specialties' },
